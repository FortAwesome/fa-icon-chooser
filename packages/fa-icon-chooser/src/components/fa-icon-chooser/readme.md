...
| `"sharp-solid-requires-pro"`            | message about requirements for accessing sharp solid icons          |
| `"sharp-solid-style-filter-sr-message"` | screen reader only message for style filter: sharp solid            |
